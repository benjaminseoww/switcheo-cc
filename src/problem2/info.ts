// taken from https://interview.switcheo.com/prices.json

// assuming the prices are added in relation to USD
// assuming that prices later in the list is the most accurate one
// (ex. USDC 07:30.000 price is more accurate than USDC 07:40.000 even though it was taken earlier)

export const tokenOptions = ['USD', 'ETH', 'USDC', 'BUSD', 'WBTC', 'wstETH', 'SWTH', 'ZIL', 'GMX', 'ATOM', 'OSMO', 'LUNA', 'ampLUNA', 'stLUNA', 
    'EVMOS', 'OKB', 'axlUSDC', 'stOSMO', 'stATOM', 'KUJI', 'stEVMOS', 'STRD', 'IBCX', 'IRIS', 'rSWTH', 'LSI', 'OKT', 'USC', 'YieldUSD', 
    'BLUR', 'bNEO', 'rATOM']
