...
const (
	...
	Query_ShowResource_FullMethodName    = "/blockchain.blockchain.Query/ShowResource"
	Query_ListResource_FullMethodName    = "/blockchain.blockchain.Query/ListResource"
	Query_FilterResources_FullMethodName = "/blockchain.blockchain.Query/FilterResources"
)
...
func (c *queryClient) FilterResources(ctx context.Context, in *QueryFilterResourcesRequest, opts ...grpc.CallOption) (*QueryFilterResourcesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_FilterResources_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) FilterResources(context.Context, *QueryFilterResourcesRequest) (*QueryFilterResourcesResponse, error) {
...
func _Query_FilterResources_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_FilterResources_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
